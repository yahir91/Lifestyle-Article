...
ActiveRecord::Schema.define(version: 20_200_925_072_823) do
  ...
  create_table 'game_categories', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index ['article_id'], name: 'index_game_categories_on_article_id'
  ...
  add_foreign_key 'game_categories', 'articles'
